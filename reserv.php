...
<br><br>
<div class="container">
    <h1 class="fw-light text-center text-lg-start mt-4 mb-0"><br>New Reservation</h1><br>
    <div class="row">
...
if(isset($_SESSION['user_id'])){
  ...
  //error handl:
    if(isset($_GET['error3'])){
        ...
        else if($_GET['error3'] == "invalidtickets") {   
            echo '<h5 class="bg-danger text-center">Invalid Tickets, Pleast try again!</h5>';
        }
    ...
    <div class="signup-form">
        <form action="func/reservation.func.php" method="post">
		...
		<option>20:00 - 00:00</option>
        	...
        	<input type="number" class="form-control" min="1" name="num_tickets" placeholder="Tickets" required="required">
