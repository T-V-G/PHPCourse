...
<html lang="en">
<head>
    <link rel="icon" type="image/png" sizes="32x32" href="img/mainlogo.png">   
    <title>Skyline</title>
<meta charset="utf-8">
		...
		<strong><em>Skyline</em></strong>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="reserv.php" >New Reservation</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="view_reservation.php" >View Reservations</a>
                    </li>';
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="ticket_edit.php" >Edit Tickets</a>
                    </li>
                    <li class="nav-item">
	            ...
	            <li class="nav-item">
                    ...
                    echo '
                    <form class="navbar-form navbar-right" action="func/logout.php" method="post">
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="func/signup.php" method="post">
                            ...
                            <div class="text-center">Already have an account? <a href="" data-toggle="modal" data-target="#myModal_login" data-dismiss="modal">Sign in</a></div>
                    </div> 	
                </div>        
                <!-- Modal footer -->
                <div class="modal-footer">
